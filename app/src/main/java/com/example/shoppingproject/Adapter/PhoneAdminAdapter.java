...
import com.example.shoppingproject.PhoneUpdateActivity;
...
public class PhoneAdminAdapter extends RecyclerView.Adapter<PhoneAdminAdapter.ItemViewHolder> {
    List<Phone> list;
    public PhoneAdminAdapter() {
        list=new ArrayList<>();
    }
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        Bitmap photo= null;
        try {
            photo = new ImageRequestAsk().execute(phone.getPhoto()).get();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(holder.itemView.getContext(), PhoneUpdateActivity.class);
