...
public class ItemAdminAdapter extends RecyclerView.Adapter<ItemAdminAdapter.ItemViewHolder>{
    List<Item> list;
    public ItemAdminAdapter() {
        list=new ArrayList<>();
    }
    ...
    @NonNull
    @Override
    public ItemAdminAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View v=inflater.inflate(R.layout.item_view,parent,false);
        return new ItemAdminAdapter.ItemViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ItemAdminAdapter.ItemViewHolder holder, int position) {
        ...
        Bitmap photo= null;
        try {
            photo = new ItemAdminAdapter.ImageRequestAsk().execute(item.getPhoto()).get();
